    ...
    <div>
      ...
      {searchQuery && (
        <div className={`mb-4 text-sm rounded-lg px-4 py-2 inline-block ${
          ...
          {filteredAMCList.length > 0 ? (
            <>Showing <span className="font-semibold text-green-700">{filteredAMCList.length}</span> of <span className="font-semibold">{amcList.length}</span> AMC contracts</>
          ) : (
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base font-medium text-green-600">{amc.servicesCompleted} completed</p>
          ...
          <div className="space-y-6">
            ...
            <div className="border-t border-gray-200 pt-4">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="font-semibold text-green-600">{selectedAMC.servicesCompleted}</span>
              </div>
              <div className="flex justify-between items-center mb-2">
