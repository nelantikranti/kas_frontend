    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-center">
          ...
          <input
            ...
            onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full pl-9 sm:pl-10 pr-4 py-2 text-sm sm:text-base border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all bg-white placeholder-gray-400"
          />
        </div>
        <select
          value={filterStatus}
          onChange={(e) => setFilterStatus(e.target.value as typeof filterStatus)}
            className="px-4 py-2.5 text-sm sm:text-base border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all bg-white w-full sm:w-auto font-medium cursor-pointer"
        ...
        >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-5 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all duration-200 font-semibold shadow-md hover:shadow-lg whitespace-nowrap w-full sm:w-auto text-sm sm:text-base transform hover:scale-[1.02] active:scale-[0.98]"
          >
      ...
      {reminders.length > 0 && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          ...
          <div className="bg-green-50 rounded-lg border-2 border-green-200 p-4 shadow-sm">
            <p className="text-xs sm:text-sm text-green-700 mb-1">Completed</p>
            ...
            return (
              <div
                ...
                className={`bg-white rounded-lg shadow-sm border-2 p-4 sm:p-6 hover:shadow-lg transition-all duration-200 ${
                  isOverdue ? "border-red-200 bg-red-50/30" : "border-gray-200 hover:border-green-200"
                }`}
              >
                    ...
                    <div className="flex items-center gap-2">
                      {reminder.status === "Pending" && (
                        <button
                          ...
                          className="flex items-center gap-1.5 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all duration-200 text-sm font-medium shadow-sm hover:shadow-md"
                        >
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            <button
              ...
              className="flex-1 px-4 py-2.5 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 transition-all duration-200 font-semibold shadow-md hover:shadow-lg transform hover:scale-[1.01] active:scale-[0.99]"
            >
              Add Reminder
            </button>
            <button
