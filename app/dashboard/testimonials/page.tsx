    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <button onClick={openCreate} className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-3 py-2 rounded-lg shadow-sm">
            ...
            <tbody>
              {loading ? (
                ...
                <tr key={t.id} className="border-b last:border-b-0 hover:bg-gray-50">
                  ...
                  <td className="py-3">
                    <span className={`px-2 py-1 text-xs rounded-full ${t.status === "approved" ? "bg-green-100 text-green-700" : t.status === "rejected" ? "bg-red-100 text-red-700" : "bg-yellow-100 text-yellow-700"}`}>
                      {t.status}
                    </span>
                  </td>
                  ...
                  <td className="py-3">
                    <div className="flex items-center gap-2">
                      ...
                      {t.status !== "approved" && <button onClick={() => handleStatusChange(t.id, "approved")} className="text-sm text-green-700 inline-flex items-center gap-1"><IoCheckmarkDone /> Approve</button>}
