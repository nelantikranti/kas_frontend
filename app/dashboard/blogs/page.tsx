      ...
      <div className="mb-6 flex flex-col gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors whitespace-nowrap text-sm sm:text-base"
          >
            ...
            <div key={blog._id || blog.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="relative h-48">
                ...
                <div className="absolute top-2 right-2">
                  {blog.published ? (
                    <span className="px-2 py-1 bg-green-500 text-white text-xs rounded">Published</span>
                  ) : (
              ...
              <div className="p-4">
                <div className="mb-2">
                  <span className="px-2 py-1 bg-green-100 text-green-800 text-xs rounded">{blog.category}</span>
                </div>
