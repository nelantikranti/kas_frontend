            ...
            {[
              ...
              <div key={index} className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0 p-3 sm:p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-left sm:text-right w-full sm:w-auto">
                  ...
                  <p className="text-xs text-green-600">+{Math.floor(Math.random() * 10 + 5)}%</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
          ...
          <div className="space-y-3 sm:space-y-4">
            {[
              ...
              { status: "Services Completed", count: 24, color: "text-green-600" },
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
        ...
        {searchQuery && (
          <div className={`mb-4 text-sm rounded-lg px-4 py-2 inline-block ${
            ...
            {filteredTeamData.length > 0 ? (
              <>Showing <span className="font-semibold text-green-700">{filteredTeamData.length}</span> of <span className="font-semibold">{teamPerformanceData.length}</span> executives</>
            ) : (
              ...
              <div key={index} className="bg-gray-50 rounded-lg p-4 space-y-2">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-green-600 font-medium">{exec.conversion}</p>
                  </div>
                </div>
              </div>
            ))
