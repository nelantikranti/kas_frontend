  ...
  return (
    <div>
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all bg-white"
          />
        </div>
      </div>
      ...
      {searchQuery && filteredDemoRequests.length > 0 && (
        <div className="mb-4 text-sm text-gray-600 bg-green-50 border border-green-200 rounded-lg px-4 py-2 inline-block">
          Showing <span className="font-semibold text-green-700">{filteredDemoRequests.length}</span> of <span className="font-semibold">{demoRequests.length}</span> results
        </div>
      )}
