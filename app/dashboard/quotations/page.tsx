    ...
    <div>
      ...
      {searchQuery && (
        <div className={`mb-4 text-sm rounded-lg px-4 py-2 inline-block ${
          ...
          {filteredQuotations.length > 0 ? (
            <>Showing <span className="font-semibold text-green-700">{filteredQuotations.length}</span> of <span className="font-semibold">{quotationList.length}</span> quotations</>
          ) : (
      ...
      >
        {previewQuotation && (
          <div className="space-y-6">
            <div className="border-b border-gray-200 pb-4">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">KAS Elevator</h3>
