            ...
            <div className="space-y-6">
                        ...
                        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                            ...
                            <div className="mb-4">
                                ...
                                <textarea
                                    ...
                                    className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-green-500 focus:border-green-500 min-h-[100px]"
                ...
                <div className="flex justify-end gap-3 pt-6 border-t mt-6">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="px-6 py-2.5 text-white bg-green-600 hover:bg-green-700 rounded-lg transition-colors font-medium flex items-center gap-2 shadow-lg shadow-green-600/20 disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                        {loading ? (
                            <>
